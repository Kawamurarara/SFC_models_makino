...
#定常状態
for t in range(1,51):
        model(X, x, y_p, Y, YD, YD_e, T, C, c_p, G, g_p, r, V, V_e, B_d, B_h, B_s, B_cb, ΔB_h, ΔB_s, ΔB_cb, H_d, H_s, H_h, a, v, c, θ, α_1, α_2, λ_0, λ_1, λ_2, A, B, t)
line = ax.plot(Time, ΔB_s, label = "定常状態")

#第５期のみ第４財への財政支出を20から30に変更
for t in range(1,51):
    if t < 5:
        model(X1, x1, y_p1, Y1, YD1, YD_e1, T1, C1, c_p1, G, g_p, r, V1, V_e1, B_d1, B_h1, B_s1, B_cb1, ΔB_h1, ΔB_s1, ΔB_cb1, H_d1, H_s1, H_h1, a, v, c, θ, α_1, α_2, λ_0, λ_1, λ_2, A, B1, t)
    elif t == 5:
        G = 110
        g_p = [5, 10, 15, 30, 50]
        model(X1, x1, y_p1, Y1, YD1, YD_e1, T1, C1, c_p1, G, g_p, r, V1, V_e1, B_d1, B_h1, B_s1, B_cb1, ΔB_h1, ΔB_s1, ΔB_cb1, H_d1, H_s1, H_h1, a, v, c, θ, α_1, α_2, λ_0, λ_1, λ_2, A, B1, t)
        ...
        g_p = [5, 10, 15, 20, 50]
        model(X1, x1, y_p1, Y1, YD1, YD_e1, T1, C1, c_p1, G, g_p, r, V1, V_e1, B_d1, B_h1, B_s1, B_cb1, ΔB_h1, ΔB_s1, ΔB_cb1, H_d1, H_s1, H_h1, a, v, c, θ, α_1, α_2, λ_0, λ_1, λ_2, A, B1, t)
line1 = ax.plot(Time, ΔB_s1, label = "財政支出拡大(第５期のみ)")

#第５期以降も第４財への財政支出を20から30に変更
for t in range(1,51):
    if t < 5:
        model(X2, x2, y_p2, Y2, YD2, YD_e2, T2, C2, c_p2, G, g_p, r, V2, V_e2, B_d2, B_h2, B_s2, B_cb2, ΔB_h2, ΔB_s2, ΔB_cb2, H_d2, H_s2, H_h2, a, v, c, θ, α_1, α_2, λ_0, λ_1, λ_2, A, B2, t)
    elif t == 5:
        G = 110
        g_p = [5, 10, 15, 30, 50]
        model(X2, x2, y_p2, Y2, YD2, YD_e2, T2, C2, c_p2, G, g_p, r, V2, V_e2, B_d2, B_h2, B_s2, B_cb2, ΔB_h2, ΔB_s2, ΔB_cb2, H_d2, H_s2, H_h2, a, v, c, θ, α_1, α_2, λ_0, λ_1, λ_2, A, B2, t)
        ...
        model(X2, x2, y_p2, Y2, YD2, YD_e2, T2, C2, c_p2, G, g_p, r, V2, V_e2, B_d2, B_h2, B_s2, B_cb2, ΔB_h2, ΔB_s2, ΔB_cb2, H_d2, H_s2, H_h2, a, v, c, θ, α_1, α_2, λ_0, λ_1, λ_2, A, B2, t)
line2 = ax.plot(Time, ΔB_s2, label = "財政支出拡大(第５期以降)")
...
for t in range(1,51):
    if t < 5:
        model(X3, x3, y_p3, Y3, YD3, YD_e3, T3, C3, c_p3, G, g_p, r, V3, V_e3, B_d3, B_h3, B_s3, B_cb3, ΔB_h3, ΔB_s3, ΔB_cb3, H_d3, H_s3, H_h3, a, v, c, θ, α_1, α_2, λ_0, λ_1, λ_2, A, B3, t)
    elif t == 5:
        θ = 0.14
        model(X3, x3, y_p3, Y3, YD3, YD_e3, T3, C3, c_p3, G, g_p, r, V3, V_e3, B_d3, B_h3, B_s3, B_cb3, ΔB_h3, ΔB_s3, ΔB_cb3, H_d3, H_s3, H_h3, a, v, c, θ, α_1, α_2, λ_0, λ_1, λ_2, A, B3, t)
    else:
        θ = 0.15
        model(X3, x3, y_p3, Y3, YD3, YD_e3, T3, C3, c_p3, G, g_p, r, V3, V_e3, B_d3, B_h3, B_s3, B_cb3, ΔB_h3, ΔB_s3, ΔB_cb3, H_d3, H_s3, H_h3, a, v, c, θ, α_1, α_2, λ_0, λ_1, λ_2, A, B3, t)
line3 = ax.plot(Time, ΔB_s3, label = "減税(第５期のみ)")

#第５期以降も税率を0.15から0.14に変更
for t in range(1,51):
    if t < 5:
        model(X4, x4, y_p4, Y4, YD4, YD_e4, T4, C4, c_p4, G, g_p, r, V4, V_e4, B_d4, B_h4, B_s4, B_cb4, ΔB_h4, ΔB_s4, ΔB_cb4, H_d4, H_s4, H_h4, a, v, c, θ, α_1, α_2, λ_0, λ_1, λ_2, A, B4, t)
    elif t == 5:
        θ = 0.14
        model(X4, x4, y_p4, Y4, YD4, YD_e4, T4, C4, c_p4, G, g_p, r, V4, V_e4, B_d4, B_h4, B_s4, B_cb4, ΔB_h4, ΔB_s4, ΔB_cb4, H_d4, H_s4, H_h4, a, v, c, θ, α_1, α_2, λ_0, λ_1, λ_2, A, B4, t)
    else:
        model(X4, x4, y_p4, Y4, YD4, YD_e4, T4, C4, c_p4, G, g_p, r, V4, V_e4, B_d4, B_h4, B_s4, B_cb4, ΔB_h4, ΔB_s4, ΔB_cb4, H_d4, H_s4, H_h4, a, v, c, θ, α_1, α_2, λ_0, λ_1, λ_2, A, B4, t)
line4 = ax.plot(Time, ΔB_s4, label = "減税(第５期以降)")
...
for t in range(1,51):
    if t < 5:
        model(X5, x5, y_p5, Y5, YD5, YD_e5, T5, C5, c_p5, G, g_p, r, V5, V_e5, B_d5, B_h5, B_s5, B_cb5, ΔB_h5, ΔB_s5, ΔB_cb5, H_d5, H_s5, H_h5, a, v, c, θ, α_1, α_2, λ_0, λ_1, λ_2, A, B5, t)
    elif t == 5:
        α_1 = 4/5
        model(X5, x5, y_p5, Y5, YD5, YD_e5, T5, C5, c_p5, G, g_p, r, V5, V_e5, B_d5, B_h5, B_s5, B_cb5, ΔB_h5, ΔB_s5, ΔB_cb5, H_d5, H_s5, H_h5, a, v, c, θ, α_1, α_2, λ_0, λ_1, λ_2, A, B5, t)
    else:
        α_1 = 3/4
        model(X5, x5, y_p5, Y5, YD5, YD_e5, T5, C5, c_p5, G, g_p, r, V5, V_e5, B_d5, B_h5, B_s5, B_cb5, ΔB_h5, ΔB_s5, ΔB_cb5, H_d5, H_s5, H_h5, a, v, c, θ, α_1, α_2, λ_0, λ_1, λ_2, A, B5, t)
line5 = ax.plot(Time, ΔB_s5, label = "消費性向上昇(第５期のみ)")

#第５期以降も消費性向を0.75から0.80に変更
for t in range(1,51):
    if t < 5:
        model(X6, x6, y_p6, Y6, YD6, YD_e6, T6, C6, c_p6, G, g_p, r, V6, V_e6, B_d6, B_h6, B_s6, B_cb6, ΔB_h6, ΔB_s6, ΔB_cb6, H_d6, H_s6, H_h6, a, v, c, θ, α_1, α_2, λ_0, λ_1, λ_2, A, B6, t)
    elif t == 5:
        α_1 = 4/5
        model(X6, x6, y_p6, Y6, YD6, YD_e6, T6, C6, c_p6, G, g_p, r, V6, V_e6, B_d6, B_h6, B_s6, B_cb6, ΔB_h6, ΔB_s6, ΔB_cb6, H_d6, H_s6, H_h6, a, v, c, θ, α_1, α_2, λ_0, λ_1, λ_2, A, B6, t)
    else:
        model(X6, x6, y_p6, Y6, YD6, YD_e6, T6, C6, c_p6, G, g_p, r, V6, V_e6, B_d6, B_h6, B_s6, B_cb6, ΔB_h6, ΔB_s6, ΔB_cb6, H_d6, H_s6, H_h6, a, v, c, θ, α_1, α_2, λ_0, λ_1, λ_2, A, B6, t)
line6 = ax.plot(Time, ΔB_s6, label = "消費性向上昇(第５期以降)")

#パラメターを元の数値に戻す
α_1 = 3/4

ax.set_title("政府・債券発行純増")
ax.set_xlabel("期")
